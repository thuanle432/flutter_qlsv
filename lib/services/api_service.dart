...
class ApiService{
  static final ApiService _instace = ApiService._internal();
  ...
  Future<Response?> getDSSinhVien(int id) async{
    const url_dssv = "https://chocaycanh.club/api/lophoc/dssinhvien";
    Profile profile = Profile();
    Map<String, String> headers = {
      'Content-Type':"application/json; charset=UTF-8",
      'Authorization':'Bearer '+Profile().token,
